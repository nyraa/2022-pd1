...
Problem ID: [urERgCk0xUCz](https://ckj.imslab.org/#/problems/urERgCk0xUCz)  
</details>
...
請仔細閱讀 loader code，或許你會發現可以偷吃步的地方（？。  Read the loader code carefully, you may find points to use tricks (^ ^).
</details>
